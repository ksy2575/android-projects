...
([김수용] 인공지능을 활용한 아동용 영어 교육 어플리케이션 - https://www.youtube.com/watch?v=5yMj--cPEyk)
...
#### 프로젝트 진행 중 느낀 점
   ...
   - 구글의 오픈소스 운영체제인 안드로이드를 탑재한 스마트폰은 수없이 많기에 layout_weight와 scaletype등을 활용하여 최대한 다양한 기기에서 호환이 되도록 설계합니다.
